...
let huffman (l:(string*int) list) = 
  ...
  in
  let rec aux queue = 
    let (prio1, NodeTree{v=v1; l=l1; r=r1} , queue) = extract queue 
    in
    match queue with
        | Empty -> insert Empty prio1 (NodeTree{v=v1;l=l1;r=r1}) 
        | _ -> 
          let (prio2, NodeTree{v=v2;l=l2;r=r2} , queue) = extract queue
          in
          aux (insert queue (prio1+.prio2) (NodeTree {v=v1^v2; l=NodeTree{v=v1; l=l1; r=r1}; r=NodeTree{v=v2;l=l2;r=r2}}))
  in 
